...
const MyAccount = () => {
    return (
      <section className='max-w-[1920px] mx-auto'>
        ...
        <div className='max-w-[544px] flex flex-col justify-center mx-auto py-20 items-center'>
          <h3 className='text-black font-bold text-[32px] text-center mb-2'>Login</h3>
          <p className='text-brandPrimary3 text-[17px] font-medium text-center mb-8'>Please login using account detail below.</p>
          <Input placeholder='Email Address' type='text' className='mb-6' style={{ width: "432px", height: "57px" }} />
          <Input placeholder='Password'type='text' className='mb-6' style={{ width: "432px", height: "57px" }}/>
          <p className='text-brandPrimary3 text-[17px] font-medium mr-60 mb-2'>Forgot your password?</p>
